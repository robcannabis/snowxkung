...
client.on('ready', async () => {
 ...
 const num = parseFloat((Math.random() * 0.2 + 0.1 + Number.EPSILON).toFixed(1));
  ...
  setInterval(() => {
    ...
    const change = ['https://cdn.discordapp.com/attachments/1211159496924069909/1211164558111281182/c2141.jpg?ex=65ed33e5&is=65dabee5&hm=c6e9d1250e3e2a9a145da95e9f3d37b30aec76537be0729c8a654f69d23ae8df&']; //รูปใหญ่
    ...
    const yyyt = ['OHMALORD']; // ชื่อ button1
    const ddds = ['https://discord.gg/BJWMJd8Uhy']; // ลิ้ง button1

   const iooi = ['INSTAGRAM']; // ชื่อ button 2
   const iiio = ['https://www.instagram.com/snowx._.kung']; // ลิ้ง button 2
